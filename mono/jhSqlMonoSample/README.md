...
1. [Node.js][]: We use Node to run a development web server and build the project.
   Depending on your appSystem, you can install Node either from source or as a pre-packaged bundle.
2. [Yarn][]: We use Yarn to manage Node dependencies.
   Depending on your appSystem, you can install Yarn either from source or as a pre-packaged bundle.
...
We use yarn scripts and [Webpack][] as our build appSystem.
...
To optimize the jhSqlMonoSample application for production, run:
